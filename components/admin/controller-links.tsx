    ...
    <div className="space-y-4">
      ...
      {showForm && (
        ...
        >
          ...
          <div>
            <label htmlFor="input-expires-at" className="text-[11px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3 flex-col sm:flex-row">
                  ...
                  {/* Actions */}
                  <div className="flex items-center gap-1 sm:flex-shrink-0 mt-2 sm:mt-0 w-full sm:w-auto justify-end">
                    <a
                      href={link.url}
                      target="_blank"
