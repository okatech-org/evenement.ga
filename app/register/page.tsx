        ...
        <div className="relative rounded-3xl border border-white/60 bg-white/70 p-8 shadow-2xl shadow-gray-200/60 backdrop-blur-xl sm:p-10">
          ...
          <div className="relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {errors.general && (
                <div className="flex items-center gap-2.5 rounded-xl bg-red-50 px-4 py-3 text-sm text-red-600 ring-1 ring-red-100">
                  <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
                  </svg>
                  {errors.general}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label htmlFor="register-lastname" className="mb-1.5 block text-sm font-medium text-gray-700">
                    Nom
                  </label>
                  <input
              ...
              <div>
                <label htmlFor="register-confirm-password" className="mb-1.5 block text-sm font-medium text-gray-700">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`${getInputClass("confirmPassword")} pl-10`}
                    placeholder="••••••••"
                  />
