...
export default function RegisterPage() {
  ...
  function validate(): boolean {
    ...
    if (formData.firstName.length < 2) newErrors.firstName = "Au moins 2 caractères";
    if (formData.lastName.length < 2) newErrors.lastName = "Au moins 2 caractères";
  ...
  const inputClass =
    "w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm outline-none transition focus:border-[#7A3A50] focus:ring-2 focus:ring-[#7A3A50]/20";
  const errorInputClass =
    "w-full rounded-lg border border-red-300 px-4 py-2.5 text-sm outline-none transition focus:border-red-500 focus:ring-2 focus:ring-red-500/20";

  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#FFFDF9] via-white to-[#FFF0F3] px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-xl shadow-gray-100/50">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Commencez à créer des invitations mémorables
          </p>
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            Déjà un compte ?{" "}
            <Link href="/login" className="font-semibold text-[#7A3A50] hover:underline">
              Se connecter
            </Link>
          </p>
        </div>
