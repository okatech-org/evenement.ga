...
import { VenuesEditor, type VenueDraft } from "@/components/admin/venues-editor";
...
export default function OnboardingPage() {
  ...
  // ─── Venue handler — délégué au composant partagé VenuesEditor ────
  function setVenues(venues: VenueDraft[]) {
    setData((prev) => ({ ...prev, venues }));
  }
        ...
        {step === "event-details" && (
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-xl shadow-gray-100/50">
            ...
            >
              ...
              {/* ─── Venues (multi-location) — composant partagé ───────── */}
              <VenuesEditor
                venues={data.venues}
